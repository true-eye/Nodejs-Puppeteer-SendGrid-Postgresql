...
citygear = async () => {
  ...
  while (page_index <= 20) {
    await page.goto(
      `https://www.citygear.com/catalog/clearance/brand/nike-jordan-new-balance/gender/men-women/prod.-type/shoes/page/${page_index}/sort-by/news_from_date/sort-direction/desc/show/120.html`,
