...
notreshop = async () => {
  ...
  while (page_index <= 20) {
    await page.goto(
      `https://www.notre-shop.com/collections/sale?page=${page_index}&sort_by=created-descending`,
    ...
    const pageInfo = await page.evaluate(() => {
      ...
      const productDetails = document.querySelectorAll(
        '.product-block > .product-desc .prTitle',
      )
        ...
        if (div_brand && div_title && div_price) {
          ...
          if (
            ...
            const productRef =
              ...
              div_title.firstElementChild.getAttribute('href')
      ...
      return {
        products,
        bLastPage: btnNextPage[0].nextElementSibling == undefined,
      }
    })
