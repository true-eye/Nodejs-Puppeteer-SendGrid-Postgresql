...
jimmyjazz = async () => {
  ...
  while (page_index <= 20) {
    await page.goto(
      `https://www.jimmyjazz.com/clearance?category=footwear&page=${page_index}`,
        ...
        if (product.children[2]) {
          ...
          if (
            ...
            if (div_productgrid_brand_a && div_productgrid_title_a) {
              ...
              console.log('jimmyjazz error occured line: 102')
            }
          }
          ...
          if (div_pricebox) {
            if (div_pricebox.childElementCount == 2) {
              ...
              console.log('jimmyjazz error occured line: 124')
            }
          }
