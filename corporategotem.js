...
scrap_corporategotem = async (func_name) => {
    ...
    let message = `<h2 style="background: white; color: red; text-align: center;"><a href="http://corporategotem.com/products.cfm?CatID=sale" style="color: blue;">corporategotem.com</a>   Men</h2>`
