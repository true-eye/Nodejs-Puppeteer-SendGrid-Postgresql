...
sneakersnstuff = async () => {
    ...
    while (1) {
        await page.goto(`https://www.sneakersnstuff.com/en/56/sale/${page_index}?p=5954&p=2412&p=1046&p=750865&p=765746&p=750882&p=750886&p=759435&p=750920&p=750958&p=750938&p=830693&p=819032&p=760609&p=815795&p=846096&p=822236&p=766086&p=750899&p=738762&p=786078&p=791858&p=817960&p=822212&p=789701&p=792955&p=797503&p=827973&p=757442&p=750934&p=871129&p=847046&p=406887&orderBy=Published`, { waitUntil: 'domcontentloaded', timeout: 0 });
        ...
        const pageInfo = await page.evaluate(() => {
            ...
            const productDetails = document.querySelectorAll('.product-list > article > .card__content');
            for (var product of productDetails) {
                const div_name = product.children[0];
                const div_price = product.children[1];

                if (div_name && div_price) {
                    const productRef = "https://www.sneakersnstuff.com" + div_name.firstElementChild.getAttribute('href');
