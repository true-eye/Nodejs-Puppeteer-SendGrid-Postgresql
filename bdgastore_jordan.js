...
bdgastore_jordan = async () => {
  ...
  while (page_index <= 20) {
    await page.goto(
      `https://bdgastore.com/collections/sale#?Collections=Sale&Producttype=Shoes&Vendor=Air+Jordan&res_per_page=60&search_return=all&page=${page_index}`,
    )
...
exports.default = bdgastore_jordan
