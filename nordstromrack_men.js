...
nordstromrack_men = async () => {
  ...
  while (page_index <= 20) {
    await page.goto(
      `https://www.nordstromrack.com/shop/Men/Shoes/Sneakers?brands%5B%5D=Nike&page=${page_index}&sort=featured`,
      { timeout: 0 },
    )
...
exports.default = nordstromrack_men
