...
solebox = async () => {
    ...
    while (1) {
        await page.goto(`https://www.solebox.com/en/Footwear/?ldtype=grid&_artperpage=96&pgNr=0&filter=f1%3AoJORDAN+%3Bf1%3AoNIKE+%3Bf6%3AoOnline%3Bf99%3AoSale`, { waitUntil: 'domcontentloaded', timeout: 0 });
        const pageInfo = await page.evaluate(() => {
            let products = [];
            const productDetails = document.querySelectorAll('#productList > .productData > a');
